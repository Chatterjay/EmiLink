...
public final class AEQuickCraftDelayHandler {
    ...
    public static void schedule(InventoryAction action, int slotIndex, long id, int containerId, Object sourceScreen,
        ...
        ModLogger.info("AE_EMI_CTRL_CRAFT delayed-click scheduled action={} slot={} id={} container={} recipe={} screen={} menu={}",
    ...
    public static void onClientTick(ClientTickEvent.Pre event) {
        ...
        if (mc.player == null || mc.screen == null) {
            ModLogger.info("AE_EMI_CTRL_CRAFT delayed-click cancel reason=no_player_or_screen recipe={}", pending.recipeId());
            pending = null;
            return;
        }

        if (AE2Proxy.isCraftConfirmScreen(mc.screen)) {
            ModLogger.info("AE_EMI_CTRL_CRAFT delayed-click cancel reason=craft_confirm_opened recipe={} screen={}",
        ...
        if (mc.screen != pending.sourceScreen()) {
            ModLogger.info("AE_EMI_CTRL_CRAFT delayed-click cancel reason=screen_changed recipe={} old={} new={}",
                    pending.recipeId(),
        ...
        if (mc.player.containerMenu != pending.sourceMenu()
            ...
            ModLogger.info("AE_EMI_CTRL_CRAFT delayed-click cancel reason=menu_changed recipe={} oldContainer={} newMenu={} newContainer={}",
        ...
        ModLogger.info("AE_EMI_CTRL_CRAFT delayed-click send action={} slot={} id={} recipe={}",
